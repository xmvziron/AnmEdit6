...
void GLFuncTable::ResolveFunctions(bool glesContext)
{
    ...
    TRY_RESOLVE_FUNCTION(glDrawElements)
    ...
    TRY_RESOLVE_FUNCTION(glGetTexEnviv);
    ...
    TRY_RESOLVE_FUNCTION(glOrtho)
    TRY_RESOLVE_FUNCTION(glPixelStorei)
    TRY_RESOLVE_FUNCTION(glPolygonMode)
    TRY_RESOLVE_FUNCTION(glPopAttrib)
    TRY_RESOLVE_FUNCTION(glPopMatrix)
    TRY_RESOLVE_FUNCTION(glPushAttrib)
